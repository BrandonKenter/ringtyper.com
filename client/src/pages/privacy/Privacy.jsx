    ...
    <div className="text-slate-400 gap-8 flex flex-col px-10 max-w-4xl mx-auto pt-20">
      ...
      <div>
        ...
        <ul>
          <li>
            <p>
              <strong className="text-neutral-50">Account</strong> means a
          ...
          <li>
            <p>
              ...
              or &quot;Our&quot; in this Agreement) refers to RingTyper.
            </p>
          </li>
          <li>
            <p>
              <strong className="text-neutral-50">Cookies</strong> are small
          ...
          <li>
            <p>
              <strong className="text-neutral-50">Personal Data</strong> is any
          ...
          <li>
            <p>
              <strong className="text-neutral-50">Service Provider</strong>{" "}
          ...
          <li>
            <p>
              <strong className="text-neutral-50">Usage Data</strong> refers to
      ...
      <div>
        ...
        <h3 className="text-neutral-50">Types of Data Collected</h3>
        <h4>Personal Data</h4>
        <p>
        ...
        <ul>
          ...
          <li>
            <strong className="text-neutral-50">Web Beacons.</strong> Certain
        ...
        <ul>
          ...
          <li>
            <p>
              <strong className="text-neutral-50">Functionality Cookies</strong>
            </p>
            <p>Type: Persistent Cookies</p>
            <p>Administered by: Us</p>
            <p>
        ...
        <h3 className="text-neutral-50">Use of Your Personal Data</h3>
        ...
        <ul>
          ...
          <li>
            <p>
              <strong className="text-neutral-50">To contact You:</strong> To
          ...
          <li>
            <p>
              <strong className="text-neutral-50">To provide You</strong> with
          ...
          <li>
            <p>
              <strong className="text-neutral-50">For other purposes</strong>:
        ...
        <ul>
          <li>
            <strong className="text-neutral-50">With Service Providers:</strong>{" "}
            We may share Your personal information with Service Providers to
            monitor and analyze the use of our Service, to contact You.
          </li>
          <li>
            <strong className="text-neutral-50">For business transfers:</strong>{" "}
          ...
          <li>
            <strong className="text-neutral-50">With Affiliates:</strong> We may
          ...
          <li>
            <strong className="text-neutral-50">With business partners:</strong>{" "}
            We may share Your information with Our business partners to offer
            You certain products, services or promotions.
          </li>
          <li>
            <strong className="text-neutral-50">With other users:</strong> when
          ...
          <li>
            <strong className="text-neutral-50">With Your consent</strong>: We
            may disclose Your personal information for any other purpose with
            Your consent.
          </li>
        </ul>
        <h3 className="text-neutral-50">Retention of Your Personal Data</h3>
        <p>
        ...
        <h3 className="text-neutral-50">Transfer of Your Personal Data</h3>
        <p>
        ...
        <h3 className="text-neutral-50">Delete Your Personal Data</h3>
        <p>
        ...
        <h3 className="text-neutral-50">Disclosure of Your Personal Data</h3>
        ...
        <h3 className="text-neutral-50">Security of Your Personal Data</h3>
        <p>
      ...
      <div>
        ...
        <ul>
          <li>
            By email:{" "}
            <a
              href="mailto:contact@ringtyper.com?subject=Privacy"
