const Terms = () => {
  return (
    <div className="text-slate-400 gap-8 flex flex-col px-10 max-w-4xl mx-auto pt-20">
      <div className="flex flex-col items-center mx-auto max-w-2xl text-center">
        <h1 className="text-neutral-50 font-extrabold text-3xl">
          Terms and Conditions
        </h1>
        <p className="text-neutral-300">Last updated: February 23, 2024</p>
        <p>
      ...
      <div>
        ...
        <h3 className="text-neutral-50">Interpretation</h3>
        <p>
        ...
        <h3 className="text-neutral-50">Definitions</h3>
        <p>For the purposes of these Terms and Conditions:</p>
        <ul>
          <li>
            <p>
              <strong className="text-neutral-50">Affiliate</strong> means an
          ...
          <li>
            <p>
              <strong className="text-neutral-50">Country</strong> refers to the
              United States
            </p>
          </li>
          <li>
            <p>
              <strong className="text-neutral-50">Company</strong> (referred to
              as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
              or &quot;Our&quot; in this Agreement) refers to Ring Typer.
            </p>
          </li>
          <li>
            <p>
              <strong className="text-neutral-50">Device</strong> means any
          ...
          <li>
            <p>
              <strong className="text-neutral-50">Service</strong> refers to the
              Website.
            </p>
          </li>
          <li>
            <p>
              <strong className="text-neutral-50">Terms and Conditions</strong>{" "}
          ...
          <li>
            <p>
              <strong className="text-neutral-50">Website</strong> refers to
              Ring Typer, accessible from{" "}
              <a
                href="https://ringtyper.com"
          ...
          <li>
            <p>
              <strong className="text-neutral-50">You</strong> means the
      ...
      <div>
        <h2 className="text-lg font-semibold text-neutral-50">Termination</h2>
        <p>
      ...
      <div>
        <h2 className="text-lg font-semibold text-neutral-50">Governing Law</h2>
        <p>
      ...
      <div>
        ...
        <h3 className="text-neutral-50">Severability</h3>
        <p>
        ...
        <h3 className="text-neutral-50">Waiver</h3>
        <p>
      ...
      <div>
        <h2 className="text-lg font-semibold text-neutral-50">Contact Us</h2>
        <p>
        ...
        <ul>
          <li>
            By email:{" "}
            <a
              href="mailto:contact@ringtyper.com?subject=Terms"
