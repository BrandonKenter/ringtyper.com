...
const SignInForm = ({ setAuthForm }) => {
  ...
  const handleSignIn = async (values) => {
    try {
      ...
      console.error(err);
      setError("root", { message: "The email/password was incorrect" });
    }
  };
